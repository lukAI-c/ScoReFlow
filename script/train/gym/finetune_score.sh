...
# OpenAI Gym Fine-tuning Script (Score-based)
# Fine-tunes using score-based reinforcement learning.
...
# hopper: epsilon_t=0.1
# humanoid: epsilon_t=0.01
# walker2d: epsilon_t=0.1

echo "Starting OpenAI Gym Fine-tuning (Score)..."
