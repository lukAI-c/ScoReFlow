...
class PPOFlowWithScore(nn.Module, ScoreFunctionMixin):
    ...
    def __init__(self, 
                 ...
                 # ========== Score 相关参数 ==========
                 gamma_score: float = 1.0,         # Score 系数
    ...
    def get_actions(self,
        ...
        for i in range(self.inference_steps):
            ...
            # drift = vt + gamma_score * std * st
            # 用学习的 std 来控制 Score 强度
            drift = vt + self.gamma_score * std * st
    ...
    def get_logprobs(self,
        ...
        for i in range(self.inference_steps):
            ...
            drift = vt + self.gamma_score * nt_expanded * st
